...
def generate_route_page_v2(origin, destination, buses, alt_index):
    ...
    # ---- P1 SEO (2026-09-26): unique intro paragraph, SBSTC chip, to-destination links ----
    _sb = 0
    for b in faq_buses:
...
<div class="seo-hero">
  ...
  <h3 class="section-title">{L("More Buses to " + g.esc(destination), g.esc(bnplace(destination)) + " \u09af\u09be\u0993\u09af\u09bc\u09be\u09b0 \u0986\u09b0\u0993 \u09ac\u09be\u09b8")}</h3>
